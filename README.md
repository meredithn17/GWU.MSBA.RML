...
The purpose of this project is to evaluate the usefulness of the calculations performed for ProPublica's analysis of the COMPAS Recidivism Risk Scores.
